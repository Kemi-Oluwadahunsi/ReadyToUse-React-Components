    ...
    <div className={`relative w-full min-w-0 ${className}`}>
      <div ref={searchRef} className="relative flex items-center">
        ...
        <input
          ...
          className={`w-full ${showIcon ? "pl-10" : "pl-4"} pr-4 py-2.5 sm:py-3 border border-gray-300 dark:border-zinc-600 rounded-xl bg-white dark:bg-zinc-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm`}
        />
      </div>
