      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800 bg-zinc-900/50">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="font-semibold text-lg text-white">Installation Guide</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3.5 rounded-xl bg-zinc-900 border border-zinc-800 font-mono text-sm">
              <span className="text-zinc-300 select-all">$ {installCmds[pkgManager]}</span>
              <button
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-zinc-400 uppercase tracking-wider">
                2. Tailwind CSS Setup (Tailwind v4 / v3)
              </span>
              <button
                onClick={() => copyText(`@import "tailwindcss";\n@custom-variant dark (&:where(.dark, .dark *));`, "tailwind")}
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800 bg-zinc-900/50">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="font-semibold text-lg text-white">Documentation Overview</h3>
          </div>
        ...
        <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto text-sm text-zinc-300">
          <div>
            <h4 className="font-semibold text-white text-base mb-1.5">Philosophy</h4>
            <p className="text-zinc-400 leading-relaxed">
              ReadyUI is crafted to provide complete freedom without opinionated lock-in. 
              All components are built using native React hooks, standard Tailwind CSS classes, and seamless dark mode support.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-zinc-900/80 border border-zinc-800">
              <h5 className="font-medium text-white mb-1">⚡ Zero Configuration</h5>
              <p className="text-xs text-zinc-400">Works out of the box with any Vite, Next.js, Remix, or CRA setup.</p>
            </div>
            <div className="p-4 rounded-xl bg-zinc-900/80 border border-zinc-800">
              <h5 className="font-medium text-white mb-1">🎨 Tailwind CSS v4 & v3</h5>
              <p className="text-xs text-zinc-400">Class names are clean and easily customizable via standard className props.</p>
            </div>
            <div className="p-4 rounded-xl bg-zinc-900/80 border border-zinc-800">
              <h5 className="font-medium text-white mb-1">🌙 Native Dark Mode</h5>
              <p className="text-xs text-zinc-400">Built-in DarkModeProvider handles system preference, localStorage, and instant toggles.</p>
            </div>
            <div className="p-4 rounded-xl bg-zinc-900/80 border border-zinc-800">
              <h5 className="font-medium text-white mb-1">♿ Fully Accessible</h5>
              <p className="text-xs text-zinc-400">WAI-ARIA compliant keyboard navigation, ARIA attributes, and focus states.</p>
            </div>
          </div>
        </div>

        <div className="px-6 py-4 bg-zinc-900/80 border-t border-zinc-800 flex justify-end">
          <button onClick={onClose} className="px-4 py-2 rounded-lg bg-white text-zinc-950 font-medium text-sm hover:bg-zinc-200 transition-colors">
            Got it
          </button>
        </div>
      </div>
...
export const ThemesModal = ({ isOpen, onClose }) => {
  ...
  const themes = [
    { id: "zinc", name: "Zinc / Neutral", color: "bg-zinc-500", border: "border-zinc-400", hex: "#71717a" },
    { id: "blue", name: "Modern Blue", color: "bg-blue-600", border: "border-blue-500", hex: "#2563eb" },
    { id: "violet", name: "Electric Violet", color: "bg-violet-600", border: "border-violet-500", hex: "#7c3aed" },
    { id: "emerald", name: "Emerald Mint", color: "bg-emerald-600", border: "border-emerald-500", hex: "#059669" },
    { id: "rose", name: "Crimson Rose", color: "bg-rose-600", border: "border-rose-500", hex: "#e11d48" },
    { id: "amber", name: "Warm Amber", color: "bg-amber-600", border: "border-amber-500", hex: "#d97706" },
  ];
              ...
              return (
                <div
                  ...
                  className={`flex items-center justify-between p-3 rounded-xl cursor-pointer transition-colors ${
                    isSelected ? "bg-zinc-800/90 text-white" : "text-zinc-300 hover:bg-zinc-900/60"
                  }`}
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-zinc-400 line-clamp-1">{item.desc}</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <ArrowRight className={`w-4 h-4 transition-transform ${isSelected ? "text-white translate-x-0.5" : "text-zinc-600"}`} />
                  </div>
                </div>
              );
            })
